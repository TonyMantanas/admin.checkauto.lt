...
import { initAdminRuntime } from './core/runtime.js?v=20260821-4';
...
const pageControllers = {
  dashboard: () => import('./pages/dashboard.js?v=20260821-2'),
  bookings: () => import('./pages/bookings.js?v=20260821-2'),
  availability: () => import('./pages/availability.js?v=20260821-2'),
  customers: () => import('./pages/customers.js?v=20260821-1'),
  invoices: () => import('./pages/invoices.js?v=20260821-2'),
  marketing: () => import('./pages/marketing.js?v=20260821-1'),
  organization: () => import('./pages/organization.js?v=20260821-2'),
  users: () => import('./pages/users.js?v=20260821-2'),
  account: () => import('./pages/account.js?v=20260821-2'),
  login: () => import('./pages/login.js?v=20260821-1')
};
