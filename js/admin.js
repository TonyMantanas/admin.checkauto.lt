...
import { initAdminRuntime } from './core/runtime.js?v=20260810-3';
import { renderShell } from './core/shell.js?v=20260807-1';
import { state } from './core/state.js?v=20260810-3';
import { toast } from './core/toast.js?v=20260804-1';
import { validators } from './core/validation.js?v=20260727-3';

const pageControllers = {
  dashboard: () => import('./pages/dashboard.js?v=20260810-3'),
  bookings: () => import('./pages/bookings.js?v=20260802-2'),
  availability: () => import('./pages/availability.js?v=20260810-3'),
  ...
  users: () => import('./pages/users.js?v=20260810-3'),
  account: () => import('./pages/account.js?v=20260810-3'),
